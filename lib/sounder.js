...
export function initializeAudio() {
    ...
    if (audioCtx.state === 'suspended' || audioCtx.state === 'interrupted') {
        ...
        audioCtx.resume().then(() => {
            console.log("AudioContext resume successful, state:", audioCtx.state);
        }).catch(err => {
...
class Sounder {
    ...
    initialize() {
        ...
        console.log("Sounder.initialize() called");

        if (audioCtx == null) {
            console.log("AudioContext was null, calling initializeAudio()");
            initializeAudio();
        }
        ...
        try {
            ...
            console.log("Sounder specialized nodes initialized");
        } catch (e) {
            console.error("Failed to initialize sounder nodes:", e);
        }
    }
    ...
    async playText(text) {
        console.log(`Sounder.playText("${text}")`);
        if (this.isPlaying) {
        ...
        if (audioCtx && audioCtx.state !== 'running') {
            ...
            console.log("Resumed audioCtx for playText, state:", audioCtx.state);
        }
        ...
        this.isPlaying = false;
        console.log("Sounder.playText finished");
    }
